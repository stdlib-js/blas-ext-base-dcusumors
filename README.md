...
```javascript
dcusumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumors@v0.0.11-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-dcusumors/actions/workflows/test.yml/badge.svg?branch=v0.0.11
[test-url]: https://github.com/stdlib-js/blas-ext-base-dcusumors/actions/workflows/test.yml?query=branch:v0.0.11
