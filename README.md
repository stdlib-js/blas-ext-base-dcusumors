...
```javascript
dcusumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumors@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-dcusumors/tags). For example,

```javascript
dcusumors = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumors@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dcusumors = require( 'path/to/vendor/umd/blas-ext-base-dcusumors/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dcusumors@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-dcusumors.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-dcusumors

[test-image]: https://github.com/stdlib-js/blas-ext-base-dcusumors/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/blas-ext-base-dcusumors/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-dcusumors/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-dcusumors?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dcusumors.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dcusumors/main
...
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dcusumors/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dcusumors/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dcusumors/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dcusumors/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dcusumors/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dcusumors/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-dcusumors/main/LICENSE
